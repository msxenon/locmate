...
void main() {
  ...
  group('Select messages', () {
    ...
    test('Test select message when select forms have tag', () {
      var response = IcuParser()
          .parse('{choice, select, foo {<b>foo</b> message.} bar {<b>bar</b> message.} other {<b>other</b> message.}}');
  ...
  group('Compound messages', () {
    ...
    test('Test compound message of literal and plural with a tag', () {
      var response =
          IcuParser().parse('The <b>John</b> has {count, plural, one {{count} apple} other {{count} apples}}.');
    ...
    test('Test compound message of literal and plural wrapped with tag', () {
      var response =
          IcuParser().parse('<p>The <b>John</b> has {count, plural, one {{count} apple} other {{count} apples}}.</p>');
    ...
    test('Test compound message of literal and gender', () {
      var response =
          IcuParser().parse('Welcome {gender, select, male {Mr {name}} female {Mrs {name}} other {dear {name}}}.');
    ...
    test('Test compound message of literal and gender with a tag', () {
      var response = IcuParser()
          .parse('<b>Welcome</b> {gender, select, male {Mr {name}} female {Mrs {name}} other {dear {name}}}.');
    ...
    test('Test compound message of literal and gender wrapped with tag', () {
      var response = IcuParser()
          .parse('<p><b>Welcome</b> {gender, select, male {Mr {name}} female {Mrs {name}} other {dear {name}}}.</p>');
    ...
    test('Test compound message of literal and select', () {
      var response =
          IcuParser().parse('The {choice, select, admin {admin {name}} owner {owner {name}} other {user {name}}}.');
    ...
    test('Test compound message of literal and select with a tag', () {
      var response = IcuParser()
          .parse('<b>The</b> {choice, select, admin {admin {name}} owner {owner {name}} other {user {name}}}.');
    ...
    test('Test compound message of literal and select wrapped with tag', () {
      var response = IcuParser()
          .parse('<p><b>The</b> {choice, select, admin {admin {name}} owner {owner {name}} other {user {name}}}.</p>');
    ...
    test('Test compound message of argument and plural', () {
      var response =
          IcuParser().parse('{name} has {count, plural, one {{count} apple} other {{count} apples}} in the bag.');
    ...
    test('Test compound message of argument and plural with a tag', () {
      var response = IcuParser()
          .parse('The <b>{name}</b> has {count, plural, one {{count} apple} other {{count} apples}} in the bag.');
    ...
    test('Test compound message of argument and gender', () {
      var response = IcuParser()
          .parse('The {gender, select, male {Mr {name}} female {Mrs {name}} other {dear {name}}} has the {device}.');
